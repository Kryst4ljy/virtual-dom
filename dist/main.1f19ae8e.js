 ...
 * @param opts 参数配置
 */
var _default = function _default(tagName, opts) {
  // 创建一个空对象
...
var render = function render(vNode) {
  ...
  if (typeof vNode === "string") return document.createTextNode(vNode); // 其他情况默认为元素节点
  // 1.创建一个元素

  var $el = document.createElement(vNode.tagName); // 2.添加虚拟DOM对象上所有的属性

  for (var _i = 0, _Object$entries = Object.entries(vNode.props); _i < _Object$entries.length; _i++) {
...
(0, _mount.default)($app, document.getElementById("root"));
console.log($app);
